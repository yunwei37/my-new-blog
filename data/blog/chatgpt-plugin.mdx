...
>
> 本文介绍了如何使用 OpenAPI 规范记录 API，以及如何将插件连接到ChatGPT UI。同时，还提供了编写插件描述和调试插件的最佳实践。通过定义 OpenAPI 规范以及清单文件，可以来创建一个待办事项列表插件。这里还有基于 Vercel 平台的开发者模板，可以帮助您轻松开发和部署 ChatGPT 插件，并一键上线使用：[https://github.com/yunwei37/ChatGPT-plugin-vercel-template](https://github.com/yunwei37/ChatGPT-plugin-vercel-template) 。
>
...
这里还有一个基于 Vercel 平台的 ChatGPT 插件起始模板，可以帮助您轻松地部署 ChatGPT 插件，并实现一键上线服务：[https://github.com/yunwei37/ChatGPT-plugin-vercel-template](https://github.com/yunwei37/ChatGPT-plugin-vercel-template)
...
* [https://github.com/openai/plugins-quickstart](https://github.com/openai/plugins-quickstart)
