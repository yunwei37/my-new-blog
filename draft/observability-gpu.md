...
0-50us          : 1847     |****************************************  (normal baseline)
50-100us        : 2134     |*******************************************
100-500us       : 892      |*******************
500us-1ms       : 45       |*
1-10ms          : 8        |
10-100ms        : 127      |***                                        (⚠️ SPIKE cluster)
100ms+          : 15       |                                           (⚠️ SEVERE)
...
[ALERT] Streams 3,5: overlap ratio <0.7 for 200 consecutive windows (shard realignment phase)
[INFO] Copy starvation detected: 18 windows with 15-30ms compute idle time
...
[INFO] Copy starvation windows: 0
```
...
[ALERT] GPU 3: overlap ratio 0.152 << 0.7 threshold (blocked by staging dataloader)
[ROOT CAUSE] GPU 3: H2D transfer blocking compute stream before collective entry
              Staging shard pinned to GPU 3 memory → synchronous transfer serializes with NCCL
